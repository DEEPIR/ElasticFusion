   ...
   resizeStream(0)
{
    ...
    Resolution::getInstance(512, 424);//(640, 480);
    ...
    {
        Intrinsics::getInstance(364.531494, 364.531494, 256.237396, 207.297302);//(367.005, 367.0055, 256.036, 212.636);//fx=367.005,fy=367.005,ix=256.036,iy=212.636(604, 604, 515, 268);//(528, 528, 320, 240);
    }
