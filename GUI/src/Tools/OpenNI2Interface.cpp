    ...
    else
    {
        ...
        else
        {
            ...
            if(initSuccessful)
            {
                ...
                assert(findMode(width, height, fps));
// , "Sorry, mode not supported!");
...
bool OpenNI2Interface::findMode(int x, int y, int fps)
{
    ...
    {
	std::cout<<"depthModes[i].getResolutionX()="<<depthModes[i].getResolutionX()<<std::endl;
	std::cout<<"depthModes[i].getResolutionY()="<<depthModes[i].getResolutionY()<<std::endl;
	std::cout<<"depthModes[i].getFps()="<<depthModes[i].getFps()<<std::endl;
    ...
    {
	std::cout<<"rgbModes[i].getResolutionX()="<<rgbModes[i].getResolutionX()<<std::endl;
	std::cout<<"rgbModes[i].getResolutionY()="<<rgbModes[i].getResolutionY()<<std::endl;
	std::cout<<"rgbModes[i].getFps()="<<rgbModes[i].getFps()<<std::endl;
