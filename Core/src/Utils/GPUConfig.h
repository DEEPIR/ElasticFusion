...
class GPUConfig
{
    ...
    private:
           ...
           so3StepBlocks(64)
        {
            ...
            icpStepMap["GeForce GTX 1060 6GB"] = std::pair<int, int>(128, 80);
            rgbStepMap["GeForce GTX 1060 6GB"] = std::pair<int, int>(160, 48);
            rgbResMap["GeForce GTX 1060 6GB"] = std::pair<int, int>(448, 80);
            so3StepMap["GeForce GTX 1060 6GB"] = std::pair<int, int>(64, 80);
